      ...
      <>
        <div className="p-4 mx-48">
          {competitionItems.map((competitionItem, index) => (
            <div className="font-bold " key={index} onClick={() => handleItemClick(competitionItem)}>
              <div className="flex flex-row justify-between cursor-pointer text-gray-500 hover:bg-slate-100 p-4">
                <div className="block">
                  <div className="text-xl text-black">{competitionItem.title}</div>
