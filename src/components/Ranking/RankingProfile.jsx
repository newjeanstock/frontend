...
const RankingProfile = ({ parameter, myRanking, rank }) => {
  ...
  return (
    <div className="flex justify-between gap-8 px-36 py-6 bg-yellow3 rounded-2xl min-w-max font-bold text-black dark:text-black">
      <div className="flex-1 flex justify-center items-center gap-8 min-w-max">
        ...
        <div className="flex flex-col gap-2">
          ...
          <h2 className="text-3xl font-bold pb-2">{myRanking.nickname}</h2>
          <span className="text-gray-500">
            대회 {myRanking.competitionCount}회 참여
          </span>
          <span className="text-gray-500">
