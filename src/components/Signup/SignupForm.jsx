...
const SignupForm = () => {
  ...
  const clickKakao = () => {
    ...
    window.location.href = `https://j11a502.p.ssafy.io/api/auth/login/kakao`;
  };
  return (
    <div className="flex flex-col w-full items-center justify-center pt-14 pb-20 gap-3">
      ...
      <form className="flex flex-col items-center" onSubmit={handleSubmit}>
        <div className="flex flex-col pb-3">
          <label
            className="text-left font-semibold text-sm text-gray-500 "
            htmlFor="nickname"
          >
            닉네임
          </label>
          <div className="w-72 h-12 flex">
            <input
              className="flex-1 border-2 border-gray-200 rounded-md mt-1 p-3 text-xs"
              type="text"
            ...
            />
            <button
              className="h-10 mt-1 ml-2 px-2 py-1 bg-yellow2 rounded-md font-bold text-gray-500 text-xs hover:bg-yellow-300 hover:text-black"
              type="button"
        ...
        <div className="flex flex-col pb-3">
          ...
          <input
            className="w-72 h-12 border-2 border-gray-200 rounded-md mt-1 p-3 text-xs"
            type="password"
        ...
        <div>
          <button
            className="w-72 h-11 bg-yellow2 rounded-md font-bold text-gray-500 hover:bg-yellow-300 hover:text-black"
